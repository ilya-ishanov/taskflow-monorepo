...
public class RabbitMQConfig {
    ...
    public DirectExchange taskHistoryExchange() {
        return new DirectExchange(TASK_HISTORY_EXCHANGE);
    }

    @Bean
    public Binding bindTaskHistoryQueueToDirectExchange(@Qualifier("taskHistoryQueue") Queue queue,
                                                  @Qualifier("taskHistoryExchange") DirectExchange directExchange) {
        return BindingBuilder.bind(queue).to(directExchange).with("task.history.created");
    }
    ...
    public Queue taskNotificationsQueue() {
        return new Queue(QUEUE_NOTIFICATIONS, true, true, false);
    }
